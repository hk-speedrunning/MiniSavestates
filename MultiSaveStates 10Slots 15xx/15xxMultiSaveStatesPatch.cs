...
namespace Patches
{
            ...
            try
            {
                switch (slots)
                {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        savedState = JsonUtility.FromJson<SavedState>(File.ReadAllText(Application.persistentDataPath + "/minisavestates-saved6.json"));
                        break;
                    case 7:
                        savedState = JsonUtility.FromJson<SavedState>(File.ReadAllText(Application.persistentDataPath + "/minisavestates-saved7.json"));
                        break;
                    case 8:
                        savedState = JsonUtility.FromJson<SavedState>(File.ReadAllText(Application.persistentDataPath + "/minisavestates-saved8.json"));
                        break;
                    case 9:
                        savedState = JsonUtility.FromJson<SavedState>(File.ReadAllText(Application.persistentDataPath + "/minisavestates-saved9.json"));
                        break;
                    case 0:
                        savedState = JsonUtility.FromJson<SavedState>(File.ReadAllText(Application.persistentDataPath + "/minisavestates-saved10.json"));
                        break;
                }
            }
            catch (Exception e)
            ...
            try
            {
                switch (slots)
                {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        File.WriteAllText(Application.persistentDataPath + "/minisavestates-saved6.json", JsonUtility.ToJson(savedState));
                        break;
                    case 7:
                        File.WriteAllText(Application.persistentDataPath + "/minisavestates-saved7.json", JsonUtility.ToJson(savedState));
                        break;
                    case 8:
                        File.WriteAllText(Application.persistentDataPath + "/minisavestates-saved8.json", JsonUtility.ToJson(savedState));
                        break;
                    case 9:
                        File.WriteAllText(Application.persistentDataPath + "/minisavestates-saved9.json", JsonUtility.ToJson(savedState));
                        break;
                    case 0:
                        File.WriteAllText(Application.persistentDataPath + "/minisavestates-saved10.json", JsonUtility.ToJson(savedState));
                        break;
                }
            }
            catch (Exception e)
    ...
    public class GameManagerPatch : global::GameManager
    {
        ...
        public new void Update()
        {
            ...
            {
                SaveStateManager.slots = 6;
            }
            else if (Input.GetKeyDown(KeyCode.Alpha7))
            {
                SaveStateManager.slots = 7;
            }
            else if (Input.GetKeyDown(KeyCode.Alpha8))
            {
                SaveStateManager.slots = 8;
            }
            else if (Input.GetKeyDown(KeyCode.Alpha9))
            {
                SaveStateManager.slots = 9;
            }
            else if (Input.GetKeyDown(KeyCode.Alpha0))
            {
                SaveStateManager.slots = 10;
            }
